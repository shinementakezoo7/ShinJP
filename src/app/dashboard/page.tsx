...
import AsanohaPattern from '@/components/japanese/AsanohaPattern'
import BambooSection from '@/components/japanese/BambooSection'
...
const MountFuji = dynamic(() => import('@/components/japanese/MountFuji'), { ssr: false })
const WavePattern = dynamic(() => import('@/components/japanese/WavePattern'), { ssr: false })
const OrigamiCrane = dynamic(() => import('@/components/japanese/OrigamiCrane'), { ssr: false })
const LanternGlow = dynamic(() => import('@/components/japanese/LanternGlow'), { ssr: false })
