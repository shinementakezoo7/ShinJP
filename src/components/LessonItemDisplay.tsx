...
import { getCharacterById, getGrammarPointById, getWordById } from '@/lib/database/functions'
import type { Character, GrammarPoint, LessonItem, Word } from '@/lib/database/types'
    ...
    case 'character': {
      ...
      return (
        <div className="p-4 bg-white rounded-lg border border-gray-200">
          ...
          <div className="text-center text-gray-600">{character.meaning.join(', ')}</div>
          {character.readings && (
    ...
    case 'word': {
      ...
      return (
        <div className="p-4 bg-white rounded-lg border border-gray-200">
          ...
          {word.reading && <div className="text-lg text-gray-600 mt-1">{word.reading}</div>}
          <div className="mt-2">
