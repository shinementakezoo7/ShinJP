...
import type { Book, BookReadingProgress } from '@/lib/database/types'
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="p-6">
        ...
        {book.author && <p className="text-gray-600 mb-3">by {book.author}</p>}
        ...
        <div className="flex justify-between items-center">
          ...
          {book.total_pages && (
            <span className="text-sm text-gray-500">{book.total_pages} pages</span>
          )}
        </div>
      </div>
    </div>
